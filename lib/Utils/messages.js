...
export const prepareStickerPackMessageContent = async (stickerPack, options) => {
    const {
        stickers,
        name,
        publisher,
...
export const generateWAMessageContent = async (message, options) => {
    ...
    else if (hasNonNullishProperty(message, 'tableMessage')) {
            ...
            submessages: [
                {
                    ...
                    tableMetadata: {
                        title: message.tableMessage.title,
                        rows: message.tableMessage.rows
                    }
                }
            ]
        };
