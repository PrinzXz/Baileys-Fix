          ...
          try {
            ...
            switch (e2eType) {
              ...
              case "msmsg":
                ...
                console.log(
                  "[DEBUG decode-wa-message.js] Attempting to decrypt msmsg...",
                );
                try {
                  msgBuffer = await repository.decryptMessage({
                    jid: decryptionJid,
                    type: "msg", // Use msg type for decryption
                    ciphertext: content,
                  });
                } catch (msmsgErr) {
                  console.log(
                  ...
                  // For msmsg, we might need to use a different approach or placeholder
                  throw new Error(
